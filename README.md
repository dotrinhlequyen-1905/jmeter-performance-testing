...
![Cấu hình Test Plan](images/01-open-jmeter.png)
...
![Cấu hình HTTP Request](images/03-http-request.png)
...
![View Results Tree](images/04-view-results-tree.png)

Ảnh Summary Report:

![Summary Report](images/05-summary-report.png)

Ảnh Aggregate Report:

![Aggregate Report](images/06-aggregate-report.png)
